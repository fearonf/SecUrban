...
module.exports.register = function (req, res) {
    ...
    // no password required if using Firebase
    ...
    User
        .create({
            username: username,
            name: name,
            // no password required here if using firebase
...
//***************************************************************************************************************
// This function  is used as an alternative to using Firebase for login
//
...
module.exports.authenticate = function (req, res, next) {
    ...
    if (headerExists) {
        ...
        //original (non firebase) PART WHERE TOKEN IS DECODED AND VERIFIED
        ...
        //              // uername is stored in a variable for passing to the next controller...
